...
const AboutUs = () => {
    ...
    return (
        <div ref={main}>
            ...
            <section className="text-gray-800 body-font relative min-h-fit flex justify-center ">

                <div className=' opacity-30 h-full absolute w-full'>
                    <img
                ...
                <div id='about-desc' className={`${mode === "dark" ? '' : 'text-black'} top-1 body-font w-full bg-cover md:text-center text-justify p-y md:px-12 max-w-[55rem] pb-16`}>
                    ...
                    <p className='text-lg px-5 mb-2 first-letter:text-xl'>
            ...
            <section className={`body-font ${mode === "dark" ? "bg-black" : "bg-white"}`}>
