...
const MovingLine = () => {
    ...
    return (
        <div ref={container} className='relative'>
            <section className={`${mode === "dark" ? 'text-white' : 'text-black'} body-font w-full bg-cover md:text-center text-justify  `}>

                <div id='tech-bg-1' className='absolute top-0 right-0 opacity-30 z-0 w-[50%]'>
                    <img className='w-full h-full' alt='ok' src={img1}></img>
                </div>
                <div className="container mx-auto px-4  lg:p-16 rounded-3xl items-center mb-4 w-fit md:px-12">
                    <p className='text-gray-800 text-center my-4'>Hackathon</p>
                    ...
                    <div className={`h-[.1rem] w-full ${mode==="dark"?'bg-white':'bg-black'}`}>
                    </div>
                </div>
                ...
                <div className={` hidden lg:flex mb-4 overflow-hidden `}>
                    ...
                    <div className={` scroll-div inline-block whitespace-nowrap text-[4rem] space-x-3 uppercase`}>
